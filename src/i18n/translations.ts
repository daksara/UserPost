...
const id = {
  ...
  'learn.quizStart': 'Kuis',
  'learn.roleplay': 'Roleplay',
  'quiz.back': 'Kembali',
  'quiz.correct': 'Benar!',
  'quiz.wrong': 'Belum tepat',
  'quiz.next': 'Lanjut',
  'quiz.finish': 'Selesai',
  'quiz.progress': 'Soal {current}/{total}',
  'quiz.score': 'Skor kamu: {correct}/{total} benar',
  'learn.levelQuiz': 'Uji pemahaman',
...
const en: Record<keyof typeof id, string> = {
  ...
  'quiz.score': 'Your score: {correct}/{total} correct',
  'learn.levelQuiz': 'Test your understanding',
